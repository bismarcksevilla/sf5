...
final class MakeMixCrud extends AbstractMaker
{
    ...
    {
        $command
            ->setDescription('Crea MIX (vista, controlador y formulario) para la clase de entidad Doctrine')
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator)
    {
        ...
        $generator->generateController(
            ...
            'crud/controller/MixController.tpl.php',
            array_merge([
        ...
        $io->text(sprintf('A continuación: revise su nueva CRUD en <fg=yellow>%s/</>', Str::asRoutePath($controllerClassDetails->getRelativeNameWithoutSuffix())));
    }
